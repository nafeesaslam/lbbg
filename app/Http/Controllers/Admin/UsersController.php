...
class UsersController extends Controller
{
                    ...
                    return '
                     <div class="dropdown float-right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="'.route('users.editPerms', $model->id).'"><i class="fas fa-shield-alt"></i> Assign Role</a>
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user->hasNamedrole('super_admin')) {
            // if logged in user dont have Super Admin Role stop him
            if (!Auth::user()->hasNamedrole('super_admin')) {
    ...
    public function editPerms(Request $request, $id){

        $user = User::findOrFail($id);

        $namedRoles = NamedRole::get();
        return view('admin.users.assign',['user' => $user,'roles' => $namedRoles]);
    ...
    public function savePerms(Request $request){
        ...
        $user = new AssignRole;
        $user->named_role_id = $request->role;
