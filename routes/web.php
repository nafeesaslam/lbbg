...
Route::prefix('admin')->group(function () {
    ...
    Route::get('users/perms/{id}/edit', 'Admin\UsersController@editPerms')->name('users.editPerms');
    Route::post('users/perms/new', 'Admin\UsersController@savePerms')->name('uperms.save');
    Route::put('users/roles/{id}', 'Admin\UsersController@updateRoles')->name('users.updateRoles');
    Route::resource('users', 'Admin\UsersController');


    //Permissions
    Route::resource('perm', 'Admin\PermissionController');
